  ...
  return (
    <div className="w-[100%] flex-col lg:flex-row" style={{ position: "absolute", top: "0", zIndex: "10", display:"flex" }}>
      <div className="bg-[#212529] w-[100%] lg:w-[50%] ]">
        <h1 className="text-white pl-[50px] text-[45px] md:text-[64px] lg:pl-[80px] xl:pl-[125px] xl:pr-[70px] mt-[700px] lg:mt-[820px] xl:mt-[820px] 2xl:mt-[940px]" style={{fontWeight:"400"}}>Redefining
         Energy</h1>{/*pr-[590px] */}
